fetch('https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=24&key=AIzaSyAYmKOWgNCWc41-rsMnU0objce1Ukn4EmE')
.then((res) => {
  return res.json();
}).then((data) => {
  ...
  for(let i =0; i < video_list.length; i++) {
   ...
   // iframe_elem.setAttribute('frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"')
  // iframe_elem.src = 'https://youtu.be/s-Rr7iUb_Pw'
   // iframe_elem.classList.add(iframe)
